...
static unsigned char dflt_vartable[] =
{
	...
	'L','E','S','S','_','O','S','C','8','_','f','i','l','e', 0, EV_OK|A_EXTRA,
		/* echo %o | sed "s,^file\://\\([^/]*\\)\\(/\.*\\),-if [ -z \\"\\1\\" -o \\"\\1\\" = localhost -o \\"\\1\\" = $HOSTNAME ]; then less \\2; else echo Cannot open remote file on \\1; fi," */
		'e','c','h','o',' ','%','o',' ','|',' ','s','e','d',' ','"','s',',','^','f','i','l','e','\\',':','/','/','\\','\\','(','[','^','/',']','*','\\','\\',')','\\','\\','(','/','\\','.','*','\\','\\',')',',','-','i','f',' ','[',' ','-','z',' ','\\','\\','"','\\','\\','1','\\','\\','"',' ','-','o',' ','\\','\\','"','\\','\\','1','\\','\\','"',' ','=',' ','l','o','c','a','l','h','o','s','t',' ','-','o',' ','\\','\\','"','\\','\\','1','\\','\\','"',' ','=',' ','$','H','O','S','T','N','A','M','E',' ',']',';',' ','t','h','e','n',' ','l','e','s','s',' ','\\','\\','2',';',' ','e','l','s','e',' ','e','c','h','o',' ','C','a','n','n','o','t',' ','o','p','e','n',' ','r','e','m','o','t','e',' ','f','i','l','e',' ','o','n',' ','\\','\\','1',';',' ','f','i',',','"',
		0,
};
